...
/**
 * @namespace Core.Agent.Admin.DynamicFieldDropdownAndText
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module functions for the DynamicFieldDropdownAndText module.
 */
Core.Agent.Admin.DynamicFieldDropdownAndText = (function (TargetNS) {

    /**
     * @name RemoveValue
     * @memberof Core.Agent.Admin.DynamicFieldDropdownAndText
     * @function
    ...
    TargetNS.AddValue = function (ValueInsert) {
        ...
        $Clone.find(':input, a.RemoveButton').each(function(){
            ...
            // makes every input in dynamic field mandatory, we don't want that
            // certainly a bug, but does not affect performance afaik
        ...
        $('.DefaultValueKeyItem,.DefaultValueItem').bind('keyup', function () {
            Core.Agent.Admin.DynamicFieldDropdownAndText.RecreateDefaultValueList();
        });
    ...
    return TargetNS;
}(Core.Agent.Admin.DynamicFieldDropdownAndText || {}));
