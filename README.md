...
Данный проект - модификация OTRS для удовлетворения нужд конкретной частной компании. В частности включает интеграцию с 1С, реализацию REST вебсервисов для добавления и редактирования клиентских данных, добавление динамических полей для клиентских организаций, добавление новых типов динамических полей, автоматическое обновление базы данных клиентов с помощью RabbitMQ.
