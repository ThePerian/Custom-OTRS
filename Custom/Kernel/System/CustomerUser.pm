...
################################################################################
#	edit to make http request after adding new user

# # 	use LWP::UserAgent;
	# use HTTP::Request::Common;
	# my $url = 'URL';
	# my %UserData = $Self->CustomerUserDataGet( User => $Param{UserLogin} );
	# my $content = "{\"CustomerUser\":{";
...
################################################################################
#	edit to make http request after updating a user
