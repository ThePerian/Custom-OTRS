...
sub Data {
	...
	'CustomerCompany' => 'Компания клиента',
	'Show customer info' => 'Показать карточку клиента',
        'Customer company name' => 'Название компании клиента',
        '(e. g. my comp* or m* company)' => '(например, комп* или к*пания)',
        'Dropdown and text' => 'Выпадающий список и текст',
        'Free text' => 'Дополнительные поля',
        'free text' => 'дополнительные поля',
